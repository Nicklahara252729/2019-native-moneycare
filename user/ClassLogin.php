...
Class Login{
	...
	public function cek_login(){
		...
		2. $_SESSION['adv_token'] terdaftar di tabel tb_admin_log, dan dalam keadaan masih belum expired
	...
	public function true_login($username, $expired){
		...
		//update tb_admin_log yang salah2 di IP dan User Agent bersangkutan bila ada
		...
		//memasukkan data ke tb_admin_log dengan flag STAT = 1.
